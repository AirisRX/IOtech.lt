...
class Register(Resource):
    ...
    def post():
        ...
        if not re.fullmatch(email_regex, data['email'], re.IGNORECASE):
            return {"message": "Netinkamas el. pašto adresas"}, 422
        ...
        try:
            ...
            return {"message": "Šis el. paštas jau yra naudojamas"}, 409

        return {
                   'message': "Sėkmingai užregistruota!",
                   'name': data['name'],
                   'email': data['email'],
